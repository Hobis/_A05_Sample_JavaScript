...
function p_canvas_shapeObjMove_update(cso:Object, oso:Object):void
{
...
function p_canvas_shapeObjMove_left(oso:Object):void
{
	...
	p_canvas_shapeObjMove_update(t_cso, oso);
}
...
function p_canvas_shapeObjCopy(oso:Object):Object
{
	...
	)
	{
		...
		var t_cco:Object = {hn: t_oco.hn, vn: t_oco.vn, sn: t_oco.sn};
		t_ccos.push(t_cco);
	}
...
function p_canvas_cellMove(oco:Object, mco:Object):void
{
	...
	if (t_cell != null)
	{
		if (p_canvas_getIsCellState(mco.hn, mco.vn))
		{
